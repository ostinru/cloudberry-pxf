 ...
 * Provides a standalone S3 endpoint for PXF S3 tests, replacing the
 * in-container MinIO that was previously started by {@code entrypoint.sh}.
 * <p>
 * The container joins a shared Docker network with alias {@code minio},
 * so PXF inside the CBDB container can reach it at {@code http://minio:9000}.
