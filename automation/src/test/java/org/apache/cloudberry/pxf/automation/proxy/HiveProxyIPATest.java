...
/**
 * This class runs the proxy test against a Hadoop cluster with Kerberos constrained delegation
 ...
 */
public class HiveProxyIPATest extends HiveProxyTest {
    ...
    protected void queryResults() throws Exception {
        runSqlTest("proxy/hive_small_data_ipa");
    }
