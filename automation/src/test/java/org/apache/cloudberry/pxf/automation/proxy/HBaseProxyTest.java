...
import org.apache.cloudberry.pxf.automation.datapreparer.hbase.HBaseProxyDataPreparer;
...
public class HBaseProxyTest extends BaseProxy {
    ...
    private HBaseTable loadTable(String tableName) throws Exception {
        ...
        HBaseProxyDataPreparer dataPreparer = new HBaseProxyDataPreparer();
