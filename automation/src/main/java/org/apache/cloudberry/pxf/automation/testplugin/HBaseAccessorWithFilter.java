...
import org.apache.cloudberry.pxf.api.filter.FilterParser;
import org.apache.cloudberry.pxf.api.filter.Node;
import org.apache.cloudberry.pxf.api.filter.Operator;
import org.apache.cloudberry.pxf.api.filter.SupportedOperatorPruner;
import org.apache.cloudberry.pxf.api.filter.TreeTraverser;
...
import org.apache.cloudberry.pxf.plugins.hbase.HBaseAccessor;
import org.apache.cloudberry.pxf.plugins.hbase.HBaseFilterBuilder;
import org.apache.cloudberry.pxf.plugins.hbase.HBaseFragmentMetadata;
import org.apache.cloudberry.pxf.plugins.hbase.utilities.HBaseColumnDescriptor;
import org.apache.cloudberry.pxf.plugins.hbase.utilities.HBaseTupleDescription;
...
public class HBaseAccessorWithFilter extends BasePlugin implements Accessor {
    ...
    private void openTable() throws IOException {
        hbaseConnection = ConnectionFactory.createConnection(HBaseConfiguration.create(configuration));
        table = hbaseConnection.getTable(TableName.valueOf(context.getDataSource()));
    }
