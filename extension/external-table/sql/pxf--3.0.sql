...
CREATE FUNCTION pxf_rust_api_version() RETURNS text
AS 'MODULE_PATHNAME', 'pxf_rust_api_version_wrapper'
LANGUAGE C IMMUTABLE STRICT;

CREATE FUNCTION pxf_rust_postgres_major() RETURNS integer
AS 'MODULE_PATHNAME', 'pxf_rust_postgres_major_wrapper'
LANGUAGE C IMMUTABLE STRICT;

CREATE FUNCTION pxf_rust_validate_location(bytea, boolean) RETURNS boolean
AS 'MODULE_PATHNAME', 'pxf_rust_validate_location_wrapper'
LANGUAGE C IMMUTABLE STRICT;
